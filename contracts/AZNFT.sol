...
contract FULLNFT is ERC721, PullPayment, Ownable {
    ...
    uint8 public constant _maxMintPerTx = 10;
    uint8 public constant _presaleMaxMint = 30;
        ...
        mintCompliance(_mintAmount)
    {
        ...
        require(
            whitelist[msg.sender].hasMinted.add(_mintAmount) <= _presaleMaxMint,
